...
def extractor(file_name, model='MTT_musicnn', input_length=3, input_overlap=False, extract_features=True, verbose=False):
    ...
    if verbose:
        print("N FRAMES:", overlap)
        print("INPUT OVERLAP:", overlap)
